...
export default function SemesterDetails() {
    ...
    return (
        ...
        <View style={styles.container}>
            <Header label={"Semester Courses"} />
            <ScrollView>

                <TextLabel label={`Hey ${userDetails[0]?.last_name} your semester courses are here !!`} alignSelf={"center"} marginTop={12} fontFamily={FontFamily.Arsenal_Bold} fontWeight={"bold"} width={"95%"} textAlign={"center"} fontSize={FontSizes.LargeMedium} />
                <FlatList
                    data={cousre}
