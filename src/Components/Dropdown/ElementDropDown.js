...
import { moderateScale, scale, verticalScale } from '../../Utilitis/ResponsiveSizes';
...
const CustomDropDown = ({ Label, defaultValue, width, alignSelf, height, Bg, marginTop, data, borderRadius, marginLeft, disabled, search, statusBarIsTranslucent, setValue, value, placeholder, leftIcon }) => {
        ...
        <View style={[
            ...
            <View style={[
                ...
                height ? { height: verticalScale(height) } : {},
                    ...
                    renderRightIcon={() => <Image source={ArrowDownIcon} style={styles.arrow} />}
                    renderLeftIcon={() => leftIcon ? <Image source={leftIcon} style={styles.arrow} /> : null}
                    labelField="label"
                    disable={disabled == true ? true : false}
                    valueField="value"
                    placeholder={!isFocus ? defaultValue : placeholder ? placeholder : 'Select any option'}
